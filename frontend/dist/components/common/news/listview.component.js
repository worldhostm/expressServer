...
const NewsRow_component_1 = __importDefault(require("./NewsRow.component"));
const ListView = () => {
    const [articles, setArticles] = (0, react_1.useState)(null);
    // const { currentTab, tabs, setCurrentTab } = useTabContext();
    ...
    return ((0, jsx_runtime_1.jsx)("div", { className: "listArea", children: (0, jsx_runtime_1.jsx)("ul", { className: "listView", children: articles &&
                ...
                ((articles.type === 'news') ?
                    articles.items.map((v, inx) => {
                        return (0, jsx_runtime_1.jsx)(NewsRow_component_1.default, Object.assign({}, v), 'div' + inx);
                    })
                    : '') }) }));
};
